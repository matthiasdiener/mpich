/* 
 *   $Id: info_setf.c,v 1.4 1998/04/29 16:59:26 swider Exp $    
 *
...
void mpi_info_set_ ANSI_ARGS((MPI_Fint *, char *, char *, MPI_Fint *,
			      MPI_Fint, MPI_Fint));

/* Definitions of Fortran Wrapper routines */
void mpi_info_set_(MPI_Fint *info, char *key, char *value, MPI_Fint *__ierr, 
