/*
 *  $Id: allreduce.c,v 1.15 1994/07/13 15:31:20 lusk Exp $
 *
...
#ifndef lint
static char vcid[] = "$Id: allreduce.c,v 1.15 1994/07/13 15:31:20 lusk Exp $";
#endif /* lint */
...
MPI_Comm          comm;
{
  ...
  if ( MPIR_TEST_COMM(comm,comm) || MPIR_TEST_OP(comm,op) || 
    ...
    return MPIR_ERROR(comm, errno, "Error in MPI_ALLREDUCE" );
