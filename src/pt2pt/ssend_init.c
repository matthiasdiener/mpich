/*
 *  $Id: ssend_init.c,v 1.22 1997/01/07 01:45:29 gropp Exp $
 *
...
MPI_Request   *request;
{
    ...
    *request = handleptr;
	...
	handleptr->shandle.dest     = comm_ptr->group->lrank_to_grank[dest];
    ...
    handleptr->shandle.lrank        = comm_ptr->local_group->local_rank;
