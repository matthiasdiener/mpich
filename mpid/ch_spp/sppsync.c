...
MPID_Aint MPID_SPP_Get_Sync_Id( dmpi_handle, mpid_handle )
...
int MPID_SPP_Lookup_SyncAck( sync_id, dmpi_send_handle, mpid_send_handle )
MPID_Aint    sync_id;
...
#endif                  /* #DEBUG_END# */
MPID_SPP_Lookup_SyncAck( sync_id, &dmpi_send_handle, &mpid_send_handle );
if (!dmpi_send_handle) {
