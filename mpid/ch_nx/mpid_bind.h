...
extern void MPID_NX_Node_name ANSI_ARGS((char *, int ));
extern void MPID_NX_Version_name ANSI_ARGS((char *));
...
extern void MPID_NX_Pkt_pack ANSI_ARGS(( MPID_PKT_T *, int, int ));
extern void MPID_NX_Pkt_unpack ANSI_ARGS(( MPID_PKT_T *, int, int ));

extern void MPID_NX_Print_Send_Handle ANSI_ARGS(( MPIR_SHANDLE *));
...
extern int MPID_NX_Do_get ANSI_ARGS(( MPIR_RHANDLE *, int, MPID_PKT_GET_T * ));

extern void MPID_NX_Get_print_pkt ANSI_ARGS((FILE *, MPID_PKT_T *));
extern void MPID_NX_Print_pkt_data ANSI_ARGS((char *, char *, int ));
