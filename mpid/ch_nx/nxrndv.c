 ...
 */
int MPID_NX_Process_unexpected_rndv( dmpi_recv_handle, dmpi_unexpected )
...
if (mpid_recv_handle_unex->send_id) {
    MPID_NX_Ack_Request( dmpi_recv_handle, mpid_recv_handle_unex->from,
 ...
 */
int MPID_NX_Save_unex_rndv( dmpi_recv_handle, pkt, from )
MPIR_RHANDLE *dmpi_recv_handle;
MPID_PKT_T   *pkt;
int          from;
{
 ...
 */
int MPID_NX_Complete_recv_rndv( dmpi_recv_handle ) 
MPIR_RHANDLE *dmpi_recv_handle;
{
...
/* Respond to a request to send a message when the message is found to
   be posted */
int MPID_NX_Ack_Request( dmpi_recv_handle, from, send_id, msglen )
MPIR_RHANDLE *dmpi_recv_handle;
int          from;
MPID_Aint    send_id;
int          msglen;
...
int MPID_NX_Do_Request( recv_handle, from, send_id )
MPID_RNDV_T  recv_handle;
int          from;
MPID_Aint    send_id;
{
 ...
 */
int MPID_NX_Test_send_rndv( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
...
int MPID_NX_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
{
...
int MPID_NX_Cmpl_recv_rndv( dmpi_recv_handle )
MPIR_RHANDLE *dmpi_recv_handle;
{
 /*  && !defined(PI_NO_NRECV) */
