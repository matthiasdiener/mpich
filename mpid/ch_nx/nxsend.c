...
/* Send a short (single packet message) 
   ...
   macros expect dest) 
*/
int MPID_NX_send_short( buf, len, tag, context_id, lrank_sender, dest,
		        msgrep ) 
void *buf;
...
int MPID_NX_post_send_short( dmpi_send_handle, mpid_send_handle, len ) 
...
int MPID_NX_post_send_long_eager( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
{
...
MPID_NX_Cmpl_send_nb( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
...
if (mpid_send_handle->sid)  {
    ...
    (void)MPID_NX_check_incoming( MPID_NOTBLOCKING );
    MPID_NX_isend_wait( dmpi_send_handle );
    }
...
int MPID_NX_post_send_sync_short( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
{
...
MPID_PKT_SEND_SET(pkt,sync_id,
		  MPID_NX_Get_Sync_Id( dmpi_send_handle, mpid_send_handle ));
...
#ifdef MPID_USE_GET               /*#NONGET_START#*/
#else
int MPID_NX_post_send_sync_long_eager( dmpi_send_handle, mpid_send_handle, 
				       len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
...
void MPID_NX_Cmpl_send_sync( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle = &dmpi_send_handle->dev_shandle;
...
int len;
{
return MPID_NX_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, len );
}
                                           /*#NONGET_END#*/
int MPID_NX_post_send_sync_short( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
 ...
 ***************************************************************************/
int MPID_NX_Post_send_local( dmpi_send_handle, mpid_send_handle, len )
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int           len;
{
 ...
 */
int MPID_NX_post_send( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
int         actual_len, rc;
...
if (dest == MPID_MyWorldRank) {
    return MPID_NX_Post_send_local( dmpi_send_handle, mpid_send_handle, 
				    actual_len );
    }
 }
#endif
...
#ifdef MPID_USE_GET
    rc = MPID_NX_post_send_long_get( dmpi_send_handle, mpid_send_handle, 
				   actual_len );
#elif defined(MPID_USE_RNDV)              /*#NONGET_START#*/
    rc = MPID_NX_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, 
				      actual_len );
#else
    rc = MPID_NX_post_send_long_eager( dmpi_send_handle, mpid_send_handle, 
				       actual_len );
                                          /*#NONGET_END#*/
#endif
else
    rc = MPID_NX_post_send_short( dmpi_send_handle, mpid_send_handle, 
				    actual_len );
...
int MPID_NX_post_send_sync( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
int         actual_len, rc;
...
if (actual_len > MPID_PKT_DATA_SIZE) 
    ...
    rc = MPID_NX_post_send_sync_long_get( dmpi_send_handle, mpid_send_handle, 
					  actual_len );
#elif defined(MPID_USE_RNDV)      /*#NONGET_START#*/
    rc = MPID_NX_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, 
				      actual_len );
#else
    rc = MPID_NX_post_send_sync_long_eager( dmpi_send_handle, 
					    mpid_send_handle, actual_len );
                                  /*#NONGET_END#*/
#endif
else
    rc = MPID_NX_post_send_sync_short( dmpi_send_handle, mpid_send_handle, 
					 actual_len );
 ...
 */
int MPID_NX_Contig_blocking_send( buf, len, tag, context_id, lrank_sender, 
				  grank_dest, msgrep )
void *buf;
...
if (len <= MPID_PKT_DATA_SIZE) 
    rc = MPID_NX_send_short( buf, len, tag, context_id, lrank_sender, 
			     grank_dest, msgrep );
else 
#ifdef MPID_USE_GET
    rc = MPID_NX_send_long_get( buf, len, tag, context_id, lrank_sender, 
			        grank_dest, msgrep );
#ifdef FOO
#elif defined(MPID_USE_RNDV)              /*#NONGET_START#*/
    rc = MPID_NX_send_long_rndv( buf, len, tag, context_id, lrank_sender, 
			         grank_dest, msgrep);
#else
    rc = MPID_NX_send_long_eager( buf, len, tag, context_id, lrank_sender, 
				  grank_dest, msgrep);
                                          /*#NONGET_END#*/
#endif
#else
...
int MPID_NX_Blocking_send( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
int err = MPI_SUCCESS;
...
err = MPID_NX_post_send( dmpi_send_handle );
if (!err) MPID_NX_complete_send( dmpi_send_handle );
 ...
 */
int MPID_NX_isend_wait( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
 ...
 */
int MPID_NX_complete_send( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
int err = MPI_SUCCESS;
...
switch (dmpi_send_handle->completer) {
    ...
    case MPID_CMPL_SEND_RNDV:
	 MPID_NX_Cmpl_send_rndv( dmpi_send_handle );
         break;
#endif                                 /*#NONGET_END#*/
#ifdef MPID_USE_GET                    /*#GET_START#*/
    case MPID_CMPL_SEND_GET:
	 MPID_NX_Cmpl_send_get( dmpi_send_handle );
         break;
#endif                                 /*#GET_END#*/
#ifndef PI_NO_NSEND                    /*#NONGET_START#*/
 ...
 */
int MPID_NX_Test_send( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
#ifdef MPID_USE_RNDV                           /*#NONGET_START#*/
MPID_NX_Test_send_rndv( dmpi_send_handle );
#endif                                         
#ifndef PI_NO_NSEND
