/*
 *  $Id: chdebug.c,v 1.2 1995/08/11 00:23:49 gropp Exp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chdebug.c,v 1.2 1995/08/11 00:23:49 gropp Exp $";
#endif /* lint */
...
MPID_NEXUS_Rndv_print_pkt( fp, pkt )
FILE *fp;
MPID_PKT_T *pkt;
{
...
MPID_NEXUS_Print_pkt_data( msg, address, len )
char *msg;
char *address;
int  len;
{
