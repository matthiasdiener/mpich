/*
 *  $Id: chsend.c,v 1.35 1995/08/11 00:21:32 gropp Exp gropp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chsend.c,v 1.35 1995/08/11 00:21:32 gropp Exp gropp $";
#endif
...
void MPID_NEXUS_Init_send_code()
{
}
...
int MPID_NEXUS_post_send_short( dmpi_send_handle, mpid_send_handle, len ) 
...
int MPID_NEXUS_post_send_long_eager( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
{
...
MPID_NEXUS_Cmpl_send_nb( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
...
if (mpid_send_handle->sid)  {
    ...
    (void)MPID_NEXUS_check_incoming( MPID_NOTBLOCKING );
    MPID_NEXUS_isend_wait( dmpi_send_handle );
    }
...
int MPID_NEXUS_post_send_sync_short( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
{
...
MPID_PKT_SEND_SET(pkt,sync_id,
		  MPID_NEXUS_Get_Sync_Id( dmpi_send_handle, mpid_send_handle ));
...
#ifdef MPID_USE_GET               /*#NONGET_START#*/
#else
int MPID_NEXUS_post_send_sync_long_eager( dmpi_send_handle, mpid_send_handle, 
				       len ) 
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int len;
...
int MPID_NEXUS_Cmpl_send_sync( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle = &dmpi_send_handle->dev_shandle;
...
int len;
{
MPID_NEXUS_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, len );
}
                                           /*#NONGET_END#*/
int MPID_NEXUS_post_send_sync_short( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
 ...
 ***************************************************************************/
int MPID_NEXUS_Post_send_local( dmpi_send_handle, mpid_send_handle, len )
MPIR_SHANDLE *dmpi_send_handle;
MPID_SHANDLE *mpid_send_handle;
int           len;
{
 ...
 */
int MPID_NEXUS_post_send( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
int         actual_len, rc;
...
if (dest == MPID_MyWorldRank) {
    return MPID_NEXUS_Post_send_local( dmpi_send_handle, mpid_send_handle, 
				    actual_len );
    }
 }
#endif
...
#ifdef MPID_USE_GET
    rc = MPID_NEXUS_post_send_long_get( dmpi_send_handle, mpid_send_handle, 
				   actual_len );
#elif defined(MPID_USE_RNDV)              /*#NONGET_START#*/
    rc = MPID_NEXUS_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, 
				      actual_len );
#else
    rc = MPID_NEXUS_post_send_long_eager( dmpi_send_handle, mpid_send_handle, 
				       actual_len );
                                          /*#NONGET_END#*/
#endif
else
    rc = MPID_NEXUS_post_send_short( dmpi_send_handle, mpid_send_handle, 
				    actual_len );
...
int MPID_NEXUS_post_send_sync( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
int         actual_len, rc;
...
if (actual_len > MPID_PKT_DATA_SIZE) 
    ...
    rc = MPID_NEXUS_post_send_sync_long_get( dmpi_send_handle, mpid_send_handle, 
					  actual_len );
#elif defined(MPID_USE_RNDV)      /*#NONGET_START#*/
    rc = MPID_NEXUS_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, 
				      actual_len );
#else
    rc = MPID_NEXUS_post_send_sync_long_eager( dmpi_send_handle, 
					    mpid_send_handle, actual_len );
                                  /*#NONGET_END#*/
#endif
else
    rc = MPID_NEXUS_post_send_sync_short( dmpi_send_handle, mpid_send_handle, 
					 actual_len );
...
int MPID_NEXUS_Blocking_send( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
...
MPID_NEXUS_post_send( dmpi_send_handle );
MPID_NEXUS_complete_send( dmpi_send_handle );
 ...
 */
int MPID_NEXUS_isend_wait( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle;
 ...
 */
int MPID_NEXUS_complete_send( dmpi_send_handle ) 
MPIR_SHANDLE *dmpi_send_handle;
{
...
switch (dmpi_send_handle->completer) {
    ...
    case MPID_CMPL_SEND_RNDV:
	 MPID_NEXUS_Cmpl_send_rndv( dmpi_send_handle );
         break;
#endif                                 /*#NONGET_END#*/
#ifdef MPID_USE_GET                    /*#GET_START#*/
    case MPID_CMPL_SEND_GET:
	 MPID_NEXUS_Cmpl_send_get( dmpi_send_handle );
         break;
#endif                                 /*#GET_END#*/
#ifndef PI_NO_NSEND                    /*#NONGET_START#*/
    ...
    case MPID_CMPL_SEND_SYNC:
	 ...
	 MPID_NEXUS_Cmpl_send_sync( dmpi_send_handle );
	 break;
#endif
    default:
 ...
 */
int MPID_NEXUS_Test_send( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
#ifdef MPID_USE_RNDV                           /*#NONGET_START#*/
MPID_NEXUS_Test_send_rndv( dmpi_send_handle );
#endif                                         
#ifndef PI_NO_NSEND
 ...
 */
int MPID_NEXUS_Complete_pending()
{
