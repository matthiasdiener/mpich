...
static char *rcsid = "$Header: /nfs/globus1/src/master/nexus_dc/nexus_dc_64le.c,v 1.3 1996/12/08 19:19:30 tuecke Exp $";
...
{
    if (   format == NEXUS_DC_FORMAT_64BIT_LE
