 ...
 *
 * rcsid = "$Header: /nfs/globus1/src/master/ports0/p0_th_sol.h,v 1.16 1996/12/12 07:52:58 tuecke Exp $"
 */
...
typedef mutex_t       _p0_mutex_t;
typedef cond_t        _p0_cond_t;
typedef thread_key_t  _p0_thread_key_t;
typedef int           _p0_mutexattr_t;
