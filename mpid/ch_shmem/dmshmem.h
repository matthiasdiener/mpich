 ...
 */
#define MPID_SHMEMK_MSGLEN(dmpi_recv_handle,msglen,err) \
...
#define MPID_PKT_PACK(pkt,size,dest) MPID_SHMEM_Pkt_pack(pkt,size,dest)
#define MPID_PKT_UNPACK(pkt,size,src) MPID_SHMEM_Pkt_unpack(pkt,size,src)
#else
