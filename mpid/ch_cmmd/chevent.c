/*
 *  $Id: chevent.c,v 1.12 1995/05/09 19:08:15 gropp Exp gropp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chevent.c,v 1.12 1995/05/09 19:08:15 gropp Exp gropp $";
#endif
 ...
 */
void MPID_CMMD_check_device( blocking )
int blocking;
{
if (blocking)
