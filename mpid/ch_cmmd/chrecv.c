/*
 *  $Id: chrecv.c,v 1.39 1995/05/11 17:48:47 gropp Exp gropp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chrecv.c,v 1.39 1995/05/11 17:48:47 gropp Exp gropp $";
#endif /* lint */
...
/* them.                                                                   */
/***************************************************************************/
static int MPID_CMMD_Copy_body_short( dmpi_recv_handle, pkt, pktbuf )
...
static int MPID_CMMD_Copy_body_sync_short( dmpi_recv_handle, pkt, from )
MPIR_RHANDLE *dmpi_recv_handle;
MPID_PKT_T   *pkt;
int          from;
{
...
/* 
    ...
    sender for the data...
 */
static int MPID_CMMD_Copy_body_long( dmpi_recv_handle, pkt, from )
MPIR_RHANDLE *dmpi_recv_handle;
MPID_PKT_T   *pkt;
int          from;
{
...
static int MPID_CMMD_Copy_body_sync_long( dmpi_recv_handle, pkt, from )
MPIR_RHANDLE *dmpi_recv_handle;
MPID_PKT_T   *pkt;
int          from;
{
 ...
 */
int MPID_CMMD_post_recv( dmpi_recv_handle ) 
MPIR_RHANDLE *dmpi_recv_handle;
{
...
int MPID_CMMD_Test_recv_push( dmpi_recv_handle )
MPIR_RHANDLE *dmpi_recv_handle;
{
#ifdef MPID_USE_RNDV
if (dmpi_recv_handle->completer == MPID_CMPL_RECV_RNDV) {
    return MPID_CMMD_Test_recv_rndv( dmpi_recv_handle );
    }
#endif
return 0;
}
