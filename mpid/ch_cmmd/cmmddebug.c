...
/*
 *  $Id: chdebug.c,v 1.5 1996/01/08 19:51:41 gropp Exp gropp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chdebug.c,v 1.5 1996/01/08 19:51:41 gropp Exp gropp $";
#endif /* lint */
...
void MPID_CMMD_Get_print_pkt( fp, pkt )
FILE       *fp;
MPID_PKT_T *pkt;
{
fprintf( fp, "\
...
void MPID_CMMD_Print_pkt_data( msg, address, len )
char *msg;
char *address;
int  len;
{
...
void MPID_CMMD_Print_Send_Handle( dmpi_send_handle )
