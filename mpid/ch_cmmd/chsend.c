/*
 *  $Id: chsend.c,v 1.33 1995/05/12 22:33:58 gropp Exp gropp $
 *
...
#ifndef lint
static char vcid[] = "$Id: chsend.c,v 1.33 1995/05/12 22:33:58 gropp Exp gropp $";
#endif
...
int MPID_CMMD_Cmpl_send_sync( dmpi_send_handle )
MPIR_SHANDLE *dmpi_send_handle;
{
MPID_SHANDLE *mpid_send_handle = &dmpi_send_handle->dev_shandle;
#ifndef PI_NO_NSEND
...
switch (dmpi_send_handle->completer) {
    ...
    case MPID_CMPL_SEND_GET:
	 MPID_CMMD_Cmpl_send_get( dmpi_send_handle );
         break;
#endif
#ifndef PI_NO_NSEND
