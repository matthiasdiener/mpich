int __NUMNODES, __MYPROCID ,__N3LEN,__N3FROM,__N3TYPE,__N3FLAG ;extern double amicclk();
#define PI_NO_NSEND
#define PI_NO_NRECV
...
/* This is the "panic" handler.  Correctable errors should be passed on
   to the user (see MPID_N3K_MSGLEN) */
