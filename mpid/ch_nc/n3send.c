...
int len;
{
return MPID_N3_post_send_long_rndv( dmpi_send_handle, mpid_send_handle, len );
}
                                           /*#NONGET_END#*/
int MPID_N3_post_send_sync_short( dmpi_send_handle, mpid_send_handle, len ) 
MPIR_SHANDLE *dmpi_send_handle;
...
err = MPID_N3_post_send( dmpi_send_handle );
if (!err) MPID_N3_complete_send( dmpi_send_handle );
...
switch (dmpi_send_handle->completer) {
    ...
    default:
	 ...
	 MPID_N3_Print_Send_Handle( dmpi_send_handle );
