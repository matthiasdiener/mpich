int __NUMNODES, __MYPROCID ,__EUILEN,__EUIFROM,__EUITYPE ;static double __EUI_DBL;extern double SY_GetElapsedTime();extern void SY_GetHostName();
...
fflush(stdout);fflush(stderr);mpc_sync(ALLGRP);;
}
