...
int MPID_P4_init_hetero( argc, argv )
int  *argc;
char ***argv;
{
int  i, use_xdr;
...
void MPID_P4_Pkt_pack( pkt, size, dest )
MPID_PKT_T *pkt;
int        size, dest;
{
int i;
...
if (MPID_IS_HETERO &&
	...
	SY_ByteSwapInt((int*)pkt,size / 4 );
	}
    }
}

void MPID_P4_Pkt_unpack( pkt, size, from )
MPID_PKT_T *pkt;
int        size, from;
{
int i;
