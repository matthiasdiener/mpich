...
#define MPID_PKT_WAIT() \
    {{char *__p4lbuf=0;__P4LEN=0;__P4FROM= -1;__P4TYPE=0;p4_recv(&__P4TYPE,&__P4FROM,&__p4lbuf,&__P4LEN);memcpy(0,__p4lbuf,__P4LEN);p4_msg_free(__p4lbuf);}; from = __P4FROM;}
