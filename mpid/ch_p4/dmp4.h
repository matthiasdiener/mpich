...
#define MPID_PKT_PACK(pkt,size,dest) MPID_P4_Pkt_pack((MPID_PKT_T*)(pkt),size,dest)
#define MPID_PKT_UNPACK(pkt,size,src) MPID_P4_Pkt_unpack((MPID_PKT_T*)(pkt),size,src)
#else
