...
implements ActionListener {
  ...
  private String about = "Jumpshot, the CLOG viewer, Version 2.0\n"
  ...
  private void setupDlgs () {
    ...
    InputStream helpin = null;
    try {
      helpin = btns_URL.openStream();
    } catch ( IOException ioerr ) {
      new ErrorDiag (this, "IO Error: opening " + btns_URL + " causes error" );
    }
