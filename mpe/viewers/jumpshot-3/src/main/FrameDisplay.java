...
implements AdjustmentListener, ActionListener {
  ...
  public ViewFrameChooser    frame_chooser;
         ...
         RecDefGroup         stateDefs;  // List of state definitions
         StateGroupListPair  all_states;
         RecDefGroup         arrowDefs;  // List of arrow definitions
                       ...
                       String             title_str ) 
  {
      ...
      IsRunningStateOff  = title_str.indexOf( "MPI-Process view" ) >= 0;
  ...
  private void setupDlgs() 
  {
    ...
    def_btns = new RecDefButtons( this, init_win.dimPG, IsRunningStateOff );
    def_btns.setFloatable( true );
    def_btns.setOrientation( SwingConstants.HORIZONTAL );
    getContentPane().add( def_btns, BorderLayout.SOUTH );
    // def_btns.setOrientation( SwingConstants.VERTICAL );
    // getContentPane().add( def_btns, BorderLayout.EAST );
  }   
