/* 
 *   $Id: read_ordef.c,v 1.5 1999/08/27 20:53:33 thakur Exp $    
 *
...
void mpi_file_read_ordered_end_(MPI_Fint *fh,void *buf,MPI_Status *status, int *__ierr )
{
    MPI_File fh_c;
    
    fh_c = MPI_File_f2c(*fh);

    *__ierr = MPI_File_read_ordered_end(fh_c,buf,status);
}
